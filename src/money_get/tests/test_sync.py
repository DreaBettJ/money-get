...
def test_sync():
    ...
    from src.money_get.scripts.sync_daily import sync_all
    from src.money_get.db import init_db
    ...
    print("\n3️⃣ 检查数据...")
    import sqlite3
    conn = sqlite3.connect("data/db/money_get.db")
    cursor = conn.cursor()
...
def test_analyze():
    ...
    from src.money_get.services.llm_analyzer import analyze_stock, analyze_market
